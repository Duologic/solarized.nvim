...
local syntax = {
    ...
    -- New source: https://neovim.io/doc/user/treesitter.html#treesitter-highlight
    ...
    ['@string.special.path']        = { fg = solarized.blue },                    -- filenames
    ['@string.special.url']         = { fg = solarized.blue },                    -- URIs (e.g. hyperlinks)
    ...
    ['@number.float']               = { fg = solarized.orange },                  -- floating-point number literals
    ...
    ['@function.method']            = { fg = solarized.blue, style = 'bold' },   -- method definitions
    ['@function.method.call']       = { fg = solarized.blue },                   -- method calls
    ...
    ['@variable.parameter']         = { fg = solarized.gray },                     -- parameters of a function
    ['@variable.parameter.builtin'] = { fg = solarized.purple, style = 'italic' }, -- special parameters (e.g. _, it)
    ['@variable.member']            = { fg = solarized.paleblue, },                -- object and struct fields

    -- Not in upstream spec, legacy
    ...
    ['@module']                     = { fg = solarized.purple },                   --                modules or namespaces
    ['@module.builtin']             = { fg = solarized.purple, style = 'italic' }, --         built-in modules or namespaces
